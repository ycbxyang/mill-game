...
const NAMES=['象牙白','曜石黑'];
const AI_WORKER_VERSION='2.1.0';
const EXPERT_WORKER_VERSION='1.0.1';
...
function requestAIMove(){
  ...
  const id=++aiRequest;aiWorker.postMessage({id,state:{board:[...state.board],hand:[...state.hand],turn:state.turn},level:aiLevel,time:aiLevel==='hard'?7000:undefined});
